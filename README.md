[![build](https://github.com/opspec-pkgs/azure.sql.server.create/actions/workflows/build.yml/badge.svg)](https://github.com/opspec-pkgs/azure.sql.server.create/actions/workflows/build.yml)
